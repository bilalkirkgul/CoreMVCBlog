...
{
    public partial class newmig1702 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutDetailsOne = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutDetailsTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutImgOne = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutImgTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
